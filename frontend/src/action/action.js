...
export const onMoveItemAction = (_id) => {
    ...
    return dispatch => {
        return fetch("http://localhost:9000/api/v1/cartItems/" + "user1@gmail.com", {
            ...
            .then(res => {
                fetch('http://localhost:9000/api/v1/wishItems/' + "user1@gmail.com", {
                    method: "POST",
                    headers: {
                        'Accept': 'application/json',
                        'Content-type': 'application/json',
...
export const amountAction = (cartTotal) => {
    console.log("cartTotal", cartTotal)
    return dispatch => {
        return fetch("http://localhost:9000/api/v1/cartItems/" + "user1@gmail.com" + "/" + "amount", {
            headers: {
                Accept: "application/json",
                "Content-type": "application/json",
            },
